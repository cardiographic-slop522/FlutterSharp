...
/// Corresponds to Flutter's FilledButton widget.
/// </summary>
[Control("FilledButton", Category = "material")]
public sealed class FilledButton : Control
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FilledButton"/> class.
    /// </summary>
    public FilledButton()
    {
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FilledButton"/> class with text.
    /// </summary>
    /// <param name="text">The button text.</param>
    /// <param name="onClick">Optional click handler.</param>
    public FilledButton(string text, EventHandler? onClick = null)
    {
        Text = text;
        if (onClick != null)
        {
